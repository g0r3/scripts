...
arch-chroot /mnt /bin/bash <<EOF
/usr/bin/pacman -S --noconfirm plasma okular dolphin system-config-printer alsa-utils korganizer konsole qalculate-gtk  gwenview qt5-imageformats kimageformats simple-scan kmail kaddressbook partitionmanager kdf ark filelight latte-dock spectacle appmenu-gtk-module lib32-libdbusmenu-glib lib32-libdbusmenu-gtk2 lib32-libdbusmenu-gtk3 libdbusmenu-glib libdbusmenu-gtk2 libdbusmenu-gtk3 libdbusmenu-qt5 kwallet-pam kwalletmanager elisa print-manager
